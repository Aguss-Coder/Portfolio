    ...
    <AuroraBackground className="bg-fixed h-screen">
      <motion.div
        ...
        className="relative flex flex-col gap-4 items-center justify-center h-screen">
          ...
          <div>
            <h1 className="pb-4 text-4xl text-seasalt font-bold">Agustin Ludueña</h1>
            <p className="text-xl text-seasalt">A developer interested in AI. I want to create<br/> my own AI-powered assistant</p>
          </div>
          </div>
